...
INSERT INTO `address` VALUES (1,1,'Doi Inthaonon',18.58889676,98.48697532),(2,2,'Doi Pui',18.81665591,98.88327951),(3,3,'Doi Inthaonon',18.58889676,98.48697532),(4,3,'Kew Mae Pan',18.55602225,98.48219804),(5,4,'Doi Inthaonon',18.58889676,98.48697532),(6,5,'Doi Inthaonon',18.58889676,98.48697532);
...
CREATE TABLE `detail` (
  ...
  `publish_year` varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  `country` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'Thailand',
  `country_other` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `microhabitat` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `designate` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `detail` VALUES (1,1,1,1,'Dankittipakul & Wang','2003','Thailand','-','1000, 1750 m','pitfall trap, litter sample','pine forest, evergreen hill forest','n/a','Short retrolateral apophysis'),(2,1,1,2,'Dankittipakul & Wang','2003','Thailand','-','1500, 1500-1600, 1610, 1680 m','n/a','evergreen hill forest','road bank, funnel in crevice of trees','patronym dedicated to Anthony Osa, Auckland New Zealand'),(3,1,1,3,'Dankittipakul & Wang','2003','Thailand','-','2100, 2300, 2530 (1600 - 2560) m','pitfall trap, litter sample','evergreen hill forest','summit','type locality'),(4,1,1,4,'Dankittipakul & Wang','2003','Thailand','-','2300, 2530, 2500, 2100 m','pitfall trap','moist evergreen hill forest','n/a','adjective siam, the former name of Thailand'),(5,1,1,5,'Dankittipakul & Wang','2003','Thailand','-','2510 m','pitfall trap','moist evergreen hill forest','near summit','refer to the poited patella apophysis of the male ');
...
INSERT INTO `genus` VALUES (1,1,'Draconarius');
...
INSERT INTO `image` VALUES (1,1,'b588c18113ae45c56753cad47c6a3907','app/image/b588c18113ae45c56753cad47c6a3907'),(2,2,'b11c9d38d2d901f3b083f77396e9015e','app/image/b11c9d38d2d901f3b083f77396e9015e'),(3,3,'445f83d230e853ed2f0f4425f5a25808','app/image/445f83d230e853ed2f0f4425f5a25808'),(4,4,'a2d4182a29b7633685a0645d2bbe7a59','app/image/a2d4182a29b7633685a0645d2bbe7a59'),(5,5,'9e12a01b81176bed77603dd4ef1035be','app/image/9e12a01b81176bed77603dd4ef1035be');
...
INSERT INTO `location` VALUES (1,1,'38','569','Doi Inthanon National Park'),(2,2,'38','568','Doi Suthep-Pui National Park'),(3,3,'38','569','Doi Inthanon National Park'),(4,4,'38','569','Chomthong'),(5,5,'38','569','Doi Inthanon National Park');
...
INSERT INTO `paper` VALUES (1,1,'Dankittipakul & Wang (2003)'),(2,2,'Dankittipakul & Wang (2003)'),(3,3,'Dankittipakul & Wang (2003)'),(4,4,'Dankittipakul & Wang (2003)'),(5,5,'Dankittipakul & Wang (2003)');
...
INSERT INTO `species` VALUES (1,1,'abbreviatus'),(2,1,'anthonyi'),(3,1,'inthanonensis'),(4,1,'siamensis'),(5,1,'subulatus');
...
CREATE TABLE `user` (
  ...
  `auth` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'user',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-11-21  4:33:32
